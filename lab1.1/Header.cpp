...
{
    return ((interval <= 10000) && (interval >= 50));
}
bool isValidTime(int hours, int min, int sec, int mlsec)
{
    return !((hours < 0) || (hours > 24) || (min < 0) || (min > 60) || (sec < 0) || (sec > 60) || (mlsec < 0) || (mlsec > 1000));
}
...
{
    HWND hdlg = CreateWindowEx(NULL, L"MyDialogClass", L"ABOUT", WS_VISIBLE | WS_OVERLAPPEDWINDOW, 400, 400, 300, 200,
        hwnd, NULL, NULL, NULL);

    CreateWindowEx(NULL, L"BUTTON", L"EXIT", WS_VISIBLE | WS_CHILD, 0, 0, 100, 40, hdlg, (HMENU)DIALOG_CLOSE,
        NULL, NULL);

    CreateWindowEx(NULL, L"STATIC", L"CLOCK DISPLAYING WITH A DEFINED INTERVAL", WS_VISIBLE | WS_CHILD, 0, 50, 200, 40, hdlg, NULL,
        NULL, NULL);
}
void AddMenus(HWND hwnd)
{
    ...
    AppendMenu(underMenu, MF_STRING, SET_CURRENT_TIME, L"CURRENT TIME");
    AppendMenu(underMenu, MF_STRING, VIEW_ABOUT, L"ABOUT");
    AppendMenu(underMenu, MF_STRING, MENU_EXIT, L"EXIT");
...
void AddControls(HWND hwnd)
{
    ...
    CreateWindowEx(NULL, L"STATIC", L"INTERVAL", WS_VISIBLE | WS_CHILD,
        385, 10, 80, 20, hwnd, NULL, NULL, NULL);


    hOut = CreateWindowEx(NULL, L"STATIC", L"TIME", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"DAY", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"MONTH", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"YEAR", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"HOUR", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"MIN", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"SEC", WS_VISIBLE | WS_CHILD,
    ...
    CreateWindowEx(NULL, L"STATIC", L"MLSEC", WS_VISIBLE | WS_CHILD,
